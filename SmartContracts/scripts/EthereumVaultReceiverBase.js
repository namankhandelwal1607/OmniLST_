...
async function main() {
  ...
  const EthereumVaultReceiverBase = await ethers.getContractFactory("EthereumVaultReceiverBase");
  const ethereumVaultReceiverBase = await EthereumVaultReceiverBase.deploy(
    "0x0BF3dE8c5D3e8A2B34D2BEeB17ABfCeBaf363A59", // router eth sepolia
    "0xb396ebc709bcb8dbc06dfce6a721369bccd3b3c6", // weth token address
  ...
  await ethereumVaultReceiverBase.deployed();


  return ethereumVaultReceiverBase.address;
}
